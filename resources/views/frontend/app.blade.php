...
<head>
	...
	<!-- Icon fonts
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/assets/css/iconfont.css')}}">
        <!-- css links
            ======================================== -->
        <!-- Bootstrap link -->
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/assets/css/vendor/bootstrap.min.css')}}">
        <!-- Link Swiper's CSS -->
        <link rel="stylesheet" href="{{asset('frontend/assets/css/vendor/owl.carousel.min.css')}}">
        <!-- Magnific popup -->
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/assets/css/vendor/magnific-popup.css')}}">
        <!-- Animate css -->
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/assets/css/vendor/animate.css')}}">
...
<body>
			...
			<div class="row no-gutters">
				<div class="col-lg-6">
					<div class="img-container">
						<img src="{{asset('frontend/assets/images/subscribe-popup-img.jpg')}}" alt="subscribe img">
					</div>
				</div>
				<!-- End of .col-lg-6 -->
				<div class="col-lg-6">
			...
			<div class="side-nav-inner nicescroll-container">
				<form action="#" class="side-nav-search-form">
					<div class="form-group search-field">
						...
						<button class="side-nav-search-btn"><i class="fa-solid fa-magnifying-glass"></i></button>
					</div>
							...
							<div class="axil-contact-info-inner">
								...
								<div class="axil-contact-info">
									<address class="address">
										...
										<div>
											<a class="tel" href="tel:8884562790"><i class="fa fa-phone"></i>(888)
												456-2790</a>
										</div>
										<div>
											<a class="tel" href="tel:12125553333"><i class="fa fa-fax"></i>(121)
												255-53333</a>
										</div>
									</address>
									<!-- End of address -->
					...
					<div class="row align-items-center">
						<div class="col-md">
							<ul class="header-top-nav list-inline justify-content-center justify-content-md-start">
								<li class="current-date" id="cd">
                                    <script>
                                       let x=new Date().toLocaleDateString('en-us', { weekday:"long", year:"numeric", month:"short", day:"numeric"}) 
                                       document.getElementById('cd').innerText=x;
                                    </script>
                                </li>
				...
				<div class="container">
					<div class="navbar-inner">
						<div class="brand-logo-container">
							<a href="index.html">
								<img src="{{asset('frontend/assets/images/logo-black.svg')}}" alt="" class="brand-logo">
							</a>
						</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-8">
						<div class="axil-img-container m-b-xs-30">
							<a href="post-format-standard.html" class="d-block">
								<img src="{{asset('frontend/assets/images/top-stories/top-stories-1.jpg')}}" alt="gallery images"
									class="w-100">
					...
					<div class="col-lg-4">
						<div class="axil-img-container m-b-xs-30">
							<a href="post-format-standard.html" class="d-block">
								<img src="{{asset('frontend/assets/images/top-stories/top-stories-2.jpg')}}" alt="gallery images"
									class="w-100">
								<div class="grad-overlay"></div>
							</a>
							<div class="media post-block position-absolute">
						...
						<div class="axil-img-container m-b-xs-30">
							<a href="post-format-standard.html" class="d-block">
								<img src="{{asset('frontend/assets/images/top-stories/top-stories-3.jpg')}}" alt="gallery images"
									class="w-100">
								<div class="grad-overlay"></div>
							</a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="media post-block m-b-xs-30">
							<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
									src="{{asset('frontend/assets/images/trending-stories/trending-stories-1.jpg')}}" alt=""></a>
							<div class="media-body">
								<div class="post-cat-group m-b-xs-10">
					...
					<div class="col-lg-6">
						<div class="media post-block m-b-xs-30">
							<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
									src="{{asset('frontend/assets/images/trending-stories/trending-stories-2.jpg')}}" alt=""></a>
							<div class="media-body">
								<div class="post-cat-group m-b-xs-10">
					...
					<div class="col-lg-6">
						<div class="media post-block m-b-xs-30">
							<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
									src="{{asset('frontend/assets/images/trending-stories/trending-stories-3.jpg')}}" alt=""></a>
							<div class="media-body">
								<div class="post-cat-group m-b-xs-10">
					...
					<div class="col-lg-6">
						<div class="media post-block m-b-xs-30">
							<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
									src="{{asset('frontend/assets/images/trending-stories/trending-stories-4.jpg')}}" alt=""></a>
							<div class="media-body">
								<div class="post-cat-group m-b-xs-10">
					...
					<div class="col-lg-6">
						<div class="media post-block m-b-xs-30">
							<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
									src="{{asset('frontend/assets/images/trending-stories/trending-stories-5.jpg')}}" alt=""></a>
							<div class="media-body">
								<div class="post-cat-group m-b-xs-10">
					...
					<div class="col-lg-6">
						<div class="media post-block m-b-xs-30">
							<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
									src="{{asset('frontend/assets/images/trending-stories/trending-stories-6.jpg')}}" alt=""></a>
							<div class="media-body">
								<div class="post-cat-group m-b-xs-10">
				...
				<div class="row">
					<div class="col-lg-8">
						<div class="add-container m-b-xs-60">
							<a href="#"><img src="{{asset('frontend/assets/images/clientbanner/clientbanner.jp')}}g" alt="add one"
									class="img-fluid"></a>
						</div>
						<main class="axil-content">
							<div class="media post-block post-block__mid m-b-xs-30">
								<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
										src="{{asset('frontend/assets/images/post/post-img-3.jpg')}}" alt=""></a>
								<div class="media-body">
									<div class="post-cat-group m-b-xs-10">
							...
							<div class="media post-block post-block__mid m-b-xs-30">
								<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
										src="{{asset('frontend/assets/images/post/post-img-4.jpg')}}" alt=""></a>
								<div class="media-body">
									<div class="post-cat-group m-b-xs-10">
							...
							<div class="media post-block post-block__mid m-b-xs-30">
								<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
										src="{{asset('frontend/assets/images/post/post-img-5.jpg')}}" alt=""></a>
								<div class="media-body">
									<div class="post-cat-group m-b-xs-10">
										<a href="business.html"
							...
							<div class="media post-block post-block__mid m-b-xs-30">
								<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
										src="{{asset('frontend/assets/images/post/post-img-6.jpg')}}" alt=""></a>
								<div class="media-body">
									<div class="post-cat-group m-b-xs-10">
							...
							<div class="media post-block post-block__mid m-b-xs-30">
								<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
										src="{{asset('frontend/assets/images/post/post-img-7.jpg')}}" alt=""></a>
								<div class="media-body">
									<div class="post-cat-group m-b-xs-10">
										<a href="business.html"
							...
							<div class="media post-block post-block__mid m-b-xs-30">
								<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
										src="{{asset('frontend/assets/images/post/post-img-8.jpg')}}" alt=""></a>
								<div class="media-body">
									<div class="post-cat-group m-b-xs-10">
										<a href="business.html"
							...
							<div class="media post-block post-block__mid m-b-xs-30">
								<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
										src="{{asset('frontend/assets/images/post/post-img-9.jpg')}}" alt=""></a>
								<div class="media-body">
									<div class="post-cat-group m-b-xs-10">
										<a href="business.html"
							...
							<div class="media post-block post-block__mid m-b-xs-30">
								<a href="post-format-standard.html" class="align-self-center"><img class=" m-r-xs-30"
										src="{{asset('frontend/assets/images/post/post-img-10.jpg')}}" alt=""></a>
								<div class="media-body">
									<div class="post-cat-group m-b-xs-10">
					...
					<div class="col-lg-4">
						<aside class="post-sidebar">
							<div class="add-block-widget m-b-xs-40">
								<a href="#"><img src="{{asset('frontend/assets/images/clientbanner/clientbanner2.jpg')}}" alt="sidebar add"
										class="img-fluid"></a>
							</div>
									...
									<div class="owl-carousel owl-theme" data-owl-items="1" data-owl-loop="true"
											...
											<ul class="category-list-wrapper">
												<li class="category-list perfect-square">
													<a href="post-format-standard.html" class="list-inner"
														style="background-image: url({{asset('frontend/assets/images/category-bg/category-bg-1.png')}})">
												...
												<li class="category-list perfect-square">
													<a href="post-format-standard.html" class="list-inner"
														style="background-image: url({{asset('frontend/assets/images/category-bg/category-bg-2.png')}})">
														<div class="post-info-wrapper overlay">
												...
												<li class="category-list perfect-square">
													<a href="post-format-standard.html" class="list-inner"
														style="background-image: url({{asset('frontend/assets/images/category-bg/category-bg-3.png')}})">
														<div class="post-info-wrapper overlay">
												...
												<li class="category-list perfect-square">
													<a href="post-format-standard.html" class="list-inner"
														style="background-image: url({{asset('frontend/assets/images/category-bg/category-bg-4.png')}})">
														<div class="post-info-wrapper overlay">
															<div class="counter-inner"><span class="counter">10</span>+
															</div>
										...
										<div class="cat-carousel-inner">
											<ul class="category-list-wrapper">
												<li class="category-list perfect-square">
													<a href="post-format-standard.html" class="list-inner"
														style="background-image: url({{asset('frontend/assets/images/category-bg/category-bg-5.jpg')}})">
														<div class="post-info-wrapper overlay">
															<div class="counter-inner"><span class="counter">20</span>+
															</div>
															<h4 class="cat-title">Top Stories</h4>
												...
												<li class="category-list perfect-square">
													<a href="post-format-standard.html" class="list-inner"
														style="background-image: url({{asset('frontend/assets/images/category-bg/category-bg-6.jpg')}})">
														<div class="post-info-wrapper overlay">
															<div class="counter-inner"><span class="counter">100</span>+
															</div>
															<h4 class="cat-title">Business</h4>
												...
												<li class="category-list perfect-square">
													<a href="post-format-standard.html" class="list-inner"
														style="background-image: url({{asset('frontend/assets/images/category-bg/category-bg-7.jpg')}})">
														<div class="post-info-wrapper overlay">
															<div class="counter-inner"><span class="counter">10</span>+
															</div>
															<h4 class="cat-title">Travel</h4>
												...
												<li class="category-list perfect-square">
													<a href="post-format-standard.html" class="list-inner"
														style="background-image: url({{asset('frontend/assets/images/category-bg/category-bg-8.jpg')}})">
														<div class="post-info-wrapper overlay">
															<div class="counter-inner"><span class="counter">10</span>+
															</div>
															<h4 class="cat-title">Food</h4>
										...
										<div class="axil-content">
											<div class="media post-block post-block__small">
												<a href="post-format-standard.html" class="align-self-center"><img
														class=" m-r-xs-30" src="{{asset('frontend/assets/images/media/small-media-1.jpg')}}"
														alt="media image"></a>
												<div class="media-body">
											...
											<div class="media post-block post-block__small">
												<a href="post-format-standard.html" class="align-self-center"><img
														class=" m-r-xs-30" src="{{asset('frontend/assets/images/media/small-media-2.jpg')}}"
														alt="media image"></a>
												<div class="media-body">
													<a href="post-format-standard.html"
											...
											<div class="media post-block post-block__small">
												<a href="post-format-standard.html" class="align-self-center"><img
														class=" m-r-xs-30" src="{{asset('frontend/assets/images/media/small-media-3.jpg')}}"
														alt="media image"></a>
												<div class="media-body">
													<a href="post-format-standard.html"
											...
											<div class="media post-block post-block__small">
												<a href="post-format-standard.html" class="align-self-center"><img
														class=" m-r-xs-30" src="{{asset('frontend/assets/images/media/small-media-4.jpg')}}"
														alt="media image"></a>
												<div class="media-body">
													<a href="post-format-standard.html"
									...
									<ul class="instagram-post-list-wrapper">
										<li class="instagram-post-list perfect-square">
											<a href="#" class="list-inner"
												style="background-image: url({{asset('frontend/assets/images/instagram-post/instagram-post-1.jpg')}})">
												<div class="post-info-wrapper overlay">
													<div class="post-info">
										...
										<li class="instagram-post-list perfect-square">
											<a href="#" class="list-inner"
												style="background-image: url({{asset('frontend/assets/images/instagram-post/instagram-post-2.jpg')}})">
												<div class="post-info-wrapper overlay">
													<div class="post-info">
														<i class="feather icon-heart"></i>
														20K+
										...
										<li class="instagram-post-list perfect-square">
											<a href="#" class="list-inner"
												style="background-image: url({{asset('frontend/assets/images/instagram-post/instagram-post-3.jpg')}})">
												<div class="post-info-wrapper overlay">
													<div class="post-info">
														<i class="feather icon-heart"></i>
														20K+
										...
										<li class="instagram-post-list perfect-square">
											<a href="#" class="list-inner"
												style="background-image: url({{asset('frontend/assets/images/instagram-post/instagram-post-4.jpg')}})">
												<div class="post-info-wrapper overlay">
													<div class="post-info">
														<i class="feather icon-heart"></i>
														20K+
										...
										<li class="instagram-post-list perfect-square">
											<a href="#" class="list-inner"
												style="background-image: url({{asset('frontend/assets/images/instagram-post/instagram-post-5.jpg')}})">
												<div class="post-info-wrapper overlay">
													<div class="post-info">
														<i class="feather icon-heart"></i>
														20K+
										...
										<li class="instagram-post-list perfect-square">
											<a href="#" class="list-inner"
												style="background-image: url({{asset('frontend/assets/images/instagram-post/instagram-post-6.jpg')}})">
												<div class="post-info-wrapper overlay">
													<div class="post-info">
														<i class="feather icon-heart"></i>
														20K+
			...
			<div class="container">
					...
					<div class="row align-items-center">
						<div class="col-md">
							<div class="footer-logo-container">
								<a href="index.html">
									<img src="{{asset('frontend/assets/images/logo-symbol.svg')}}" alt="footer logo" class="footer-logo">
								</a>
							</div>
							<!-- End of .brand-logo-container -->
						</div>
				...
				<div class="footer-bottom">
					...
					<p class="axil-copyright-txt">
						© 2022. All rights reserved by YetFix Limited.
					</p>
				</div>
	...
	<script src="{{asset('frontend/assets/js/vendor/jquery-migrate.min.js')}}"></script>
	<!-- jQuery Easing Plugin -->
	<script src="{{asset('frontend/assets/js/vendor/easing-1.3.js')}}"></script>
	<!-- Waypoints js -->
	<script src="{{asset('frontend/assets/js/vendor/jquery.waypoints.min.js')}}"></script>
	<!-- Owl Carousel JS -->
	...
	<!-- Counter up js -->
	<script src="{{asset('frontend/assets/js/vendor/jquery.counterup.js')}}"></script>
	<!-- Magnific Popup js -->
	<script src="{{asset('frontend/assets/js/vendor/jquery.magnific-popup.min.js')}}"></script>
	<!-- Nicescroll js -->
	<script src="{{asset('frontend/assets/js/vendor/jquery.nicescroll.min.js')}}"></script>
